...
class kingsize_contactinfo_widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($instance['contactinfo_email'] != ''){
			if($instance['contactinfo_email_link']==1)
				echo '<li class="email"><i class="fa fa-envelope"></i> <a href="mailto:'.str_replace('<br>',';',$instance['contactinfo_email']).'">' .$instance['contactinfo_email']. '</a></li>';
			else
	...
	function update($new_instance, $old_instance) {
		...
		$instance['title'] = strip_tags($new_instance['title'],'<br>,<br/>,<b>');
		$instance['contactinfo_phone'] = strip_tags($new_instance['contactinfo_phone'],'<br>,<br/>,<b>');
		$instance['contactinfo_fax'] = strip_tags($new_instance['contactinfo_fax'],'<br>,<br/>,<b>');
		$instance['contactinfo_email'] = strip_tags($new_instance['contactinfo_email'],'<br>,<br/>,<b>');
		$instance['contactinfo_email_link'] = strip_tags($new_instance['contactinfo_email_link'],'<br>,<br/>,<b>');
		$instance['contactinfo_address'] = strip_tags($new_instance['contactinfo_address'],'<br>,<br/>,<b>');
		$instance['contactinfo_city'] = strip_tags($new_instance['contactinfo_city'],'<br>,<br/>,<b>');
		$instance['contactinfo_showmap'] = strip_tags($new_instance['contactinfo_showmap'],'<br>,<br/>,<b>');
		return $instance;
	}
	...
	function form($instance) {
		...
		$title = strip_tags($instance['title'],'<br>,<br/>,<b>');
		$contactinfo_phone = strip_tags($instance['contactinfo_phone'],'<br>,<br/>,<b>');		
		$contactinfo_fax = strip_tags($instance['contactinfo_fax'],'<br>,<br/>,<b>');		
		$contactinfo_email = strip_tags($instance['contactinfo_email'],'<br>,<br/>,<b>');	
		$contactinfo_email_link = strip_tags($instance['contactinfo_email_link'],'<br>,<br/>,<b>');	
		$contactinfo_address = strip_tags($instance['contactinfo_address'],'<br>,<br/>,<b>');	
		$contactinfo_city = strip_tags($instance['contactinfo_city'],'<br>,<br/>,<b>');
