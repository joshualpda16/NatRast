...
// Show & Remove Prices from WooCommerce Shop
if($data['wm_wc_price_enabled'] == "Enable WooCommerce Shop Pricing" || $data['wc_shop_price_show'] == "1")
{
	
}
elseif($data['wm_wc_price_enabled'] == "Disable WooCommerce Shop Pricing"){
