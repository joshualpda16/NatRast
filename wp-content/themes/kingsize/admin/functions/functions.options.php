...
if (!function_exists('of_options'))
{
	function of_options()
	{
		...
		$of_options[] = array(
					...
					'desc' => 'Upload a logo, or specify the image address. Best results when using <strong>180(h) x 200(w) px</strong>. <br /><br /><strong>Notes:</strong> <br />For logos not transparent, we recommend using an image width of <strong>195</strong> instead of 200. <br /><br />This logo does not apply to the mobile version of your site. <br />Scroll down in these options to find the Mobile Logo upload options.'
				);
		...
		$of_options[] = array(
					...
					"helpicon"=> "help.png",
					'parent_heading'=> $shortname."_logo",
					'desc' => 'Upload a logo, or specify the image address. Best results using <strong>45(h) x 120(w) px</strong>. <br />This logo is for Mobile / Tablet Devices. Width may vary for logo.'
				);
		...
		$of_options[] = array(
					...
					'desc' => 'Upload a favicon, or specify the png image address. Best results when using <strong>16(h) x 16(w) px</strong>.'
				);
		...
		$of_options[] = array(
					  ...
					  'desc' => 'Upload a global background, or specify the image address <i>[ie., http://www.yoursite.com/yourimage.jpg]</i> <br /><br /><strong>For best results</strong>, we recommend you optimize your images, using <strong>1400(w) x 900(h) px</strong>, or <strong>900(w) x 500(h) px</strong> and a <strong>max 1.5MB\'s size</strong> (though it is our recommendation you optimize your images and keep them smaller in size).'
					  );	
		...
		$of_options[] =	array( "name" => "Hide/Show Navigation Options",
					  ...
					  "helpicon"=> "help.png",
					  "desc" => "Here you can choose how the Navigation should appear. <br /><strong>-</strong> Shown by Default <br /><strong>-</strong> Hidden by Default <br /><strong>-</strong> Hidden only on the Homepage but shown on all others.",
					  "parent_heading" => $shortname."_navigation_menu");
					  
		$of_options[] = array(  "name" => "Enable / Disable Fixed Navigation",
					  "desc" => "By default the navigation is in a \"<strong>Fixed</strong>\" position. Check this to change that to \"<strong>Absolute</strong>\" positioning which means it will no longer stay fixed in the browser window while scrolling. This is resourecful for longer navigations with multiple mneu items being displayed.",
		...
		#----------------------------------------------------------------------------------------#
		###################### King Size *WP* Mobile Background Preferences #######################
		#----------------------------------------------------------------------------------------#			

		$of_options[] = array( "name" => "Homepage Mobile Background Slider Preferences",
					  "desc" => "",
					  "id" => $shortname."_slider_mobile",
					  "std" => "<h3 style=\"margin: 0 0 10px; text-align: center;\">Options specific to Mobile Background Sliders</h3>",
					  "icon" => true,
					  "type" => "info");
					  
		$of_options[] =	array(  "name" => "Enable / Disable Descriptions on Mobile",
						"desc" => "Check this box if you want to display the slider descriptions on mobile (disabled by default).",
						"id" => $shortname."_unhide_slider_mobile_desc",
						"type" => "checkbox",
						"helpicon"=> "help.png",
						"parent_heading" => $shortname."_slider_mobile",
						"std" => "1");
		...
		$of_options[] = array( "name" => "Style Preferences",
					  ...
					  "std" => "<h3 style=\"margin: 0 0 10px; text-align: center;\">Customize Your Theme Styles</h3>",
					  "icon" => true,
					  "type" => "info");
		...
		$of_options[] =	array(  "name" => "Default Body / Paragraph Font Size",
					  ...
					  "helpicon"=> "help.png",
					  "mod" => "mini",
					  "desc" => "Enter the numerical number for your font size to override the original font sizes. <br /><strong>Do not include the 'px'</strong>, just numerical entry.",
		...
		$of_options[] = array(  "name" => "Menu Background Colour",
					  "id" => $shortname."_menu_color_background",
					  "std" => "#000000",
					  "desc" => "<strong style=\"color: #ff0000;\">Important</strong>: If using the <strong>Default</strong> menu design (with the ribbon point) it will require you manually editing the bottom point as this is an image. This is not required with the other styles such as Circular, Rounded and/or Squared. You can checkout our <a href=\"#\">FAQ</a> for more details on doing this. Default theme colour is #000 (Black).",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					 
		$of_options[] = array(  "name" => "Menu Background Border Colour",
					  "id" => $shortname."_menu_color_background_border",
					  "std" => "#393836",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] =	array(  "name" => "Menu Background Colour Opacity",
					  "id" => $shortname."_menu_color_background_opacity",
					  "std" => "1",
					  "helpicon"=> "help.png",
					  "mod" => "mini",
					  "desc" => "Enter the opacity / transparency for the menu/navigation background. Using 1 will show full opacity, using 0.1 will show the least. Use 0.5 to show partial opacity and so on.",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "text");
					  
		$of_options[] = array(  "name" => "Navigation Bottom Shape / Style",
					  "id" => $shortname."_navigation_shape",
					  "std" => "Default",
					  "options" => array("default"=>"Default", "rounded"=>"Rounded", "circular"=>"Circular", "squared"=>"Squared"),
					  "desc" => "The default style of the navigation is <strong>Ribbon</strong> (pointed). Here you can choose to change that to either <strong>Circular</strong>, <strong>Rounded</strong> or <strong>Squared</strong> in style. You can checkout our <a href=\"#\">FAQ</a> for more detail.",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "select");
		...
		$of_options[] = array(  "name" => "Menu Item Divider Colour",
		...
		$of_options[] = array(  "name" => "Content Background Colour",
					  "id" => $shortname."_color_background",
					  "std" => "#000000",
					  "desc" => "The default background colour for KingSize is #000 (Black).",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Content Background Border Colour",
					  "id" => $shortname."_color_background_border",
					  "std" => "#393836",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] =	array(  "name" => "Content Background Colour Opacity",
					  "id" => $shortname."_color_background_opacity",
					  "std" => "1",
					  "helpicon"=> "help.png",
					  "mod" => "mini",
					  "desc" => "Enter the opacity / transparency for the content / container background. Using 1 will show full opacity, using 0.1 will show the least. Use 0.5 to show partial opacity and so on.",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "text");
		...
		$of_options[] = array(  "name" => "Portfolio Button Colour",
					  "id" => $shortname."_color_portfolio_btn",
					  "std" => "#111111",
					  "desc" => "This will change the colour of the More Button used by Portfolio posts.",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Portfolio Button Border Colour",
					  "id" => $shortname."_color_portfolio_btn_border",
					  "std" => "#2C2C2C",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] = array(  "name" => "Portfolio Button Text Colour",
					  "id" => $shortname."_color_portfolio_btn_text",
					  "std" => "#D2D2D7",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] = array(  "name" => "Portfolio Button Mouseover Colour",
					  "id" => $shortname."_color_portfolio_btn_mouseover",
					  "std" => "#222222",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] = array(  "name" => "Portfolio Button Mouseover Text Colour",
					  "id" => $shortname."_color_portfolio_btn_text_mouseover",
					  "std" => "#FFFFFF",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] = array(  "name" => "Portfolio Button Mouseover Border Colour",
					  "id" => $shortname."_color_portfolio_btn_border_mouseover",
					  "std" => "#2C2C2C",
					  "desc" => "",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
		...
		$of_options[] = array(  "name" => "Post Meta Borders / Dividers Colour",
					  "id" => $shortname."_post_meta_border_color",
					  "std" => "#646464",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
		...
		#-----------------------------------------------------------------------------------------------#
		###################### King Size *WP* Sidebar Related Style Preferences #######################
		#-----------------------------------------------------------------------------------------------#
					  
		$of_options[] = array( "name" => "Sidebar Related Style Preferences",
					  "desc" => "",
					  "id" => $shortname."_sidebar_style",
					  "std" => "<h3 style=\"margin: 0 0 10px; text-align: center;\">Sidebar Related Style Preferences</h3>",
					  "icon" => true,
					  "type" => "info");
					  
		$of_options[] = array(  "name" => "Widget Item Mouseover Background Colour",
					  "id" => $shortname."_wc_sidebar_color_mouseover",
					  "std" => "#2b2b2b",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Widget Item Borders / Dividers",
					  "id" => $shortname."_wc_sidebar_color_borders",
					  "std" => "#2b2b2b",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Disable the Sidebar Item Mouseover Effect",
					  "desc" => "Check this box to disable the mouseover/hover effect on widget/sidebar items.",
					  "id" => $shortname."_disable_sidebar_item_mouseover",
					  "type" => "checkbox",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_blog_prefs",
					  "std" => "");
					  
		$of_options[] = array(  "name" => "Disable the Sidebar Borders/Dividers",
					  "desc" => "Check this box to disable the borders/dividers shown in the sidebar widgets.",
					  "id" => $shortname."_disable_sidebar_item_dividers",
					  "type" => "checkbox",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_blog_prefs",
					  "std" => "");
		...
		#-----------------------------------------------------------------------------------------------#
		###################### King Size *WP* WooCommerce Preferences #######################
		#-----------------------------------------------------------------------------------------------#
					  
		$of_options[] = array( "name" => "WooCommerce Style Preferences",
					  "desc" => "",
					  "id" => $shortname."_menu_style",
					  "std" => "<h3 style=\"margin: 0 0 10px; text-align: center;\">WooCommerce Style Preferences</h3>",
					  "icon" => true,
					  "type" => "info");
					  
		$of_options[] = array(  "name" => "WooCommerce Button Colour",
					  "id" => $shortname."_wc_color_btn",
					  "std" => "#111111",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Button Mouseover Colour",
					  "id" => $shortname."_wc_color_btn_mouseover",
					  "std" => "#222222",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Button Text Colour",
					  "id" => $shortname."_wc_color_btn_text",
					  "std" => "#D2D2D2",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Button Mouseover Text Colour",
					  "id" => $shortname."_wc_color_btn_text_mouseover",
					  "std" => "#FFFFFF",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Button Border Colour",
					  "id" => $shortname."_wc_color_btn_border",
					  "std" => "#2C2C2C",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Button Mouseover Border Colour",
					  "id" => $shortname."_wc_color_btn_border_mouseover",
					  "std" => "#2C2C2C",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Tabs",
					  "id" => $shortname."_wc_color_tab",
					  "std" => "#1B1B1B",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Tab Text Colour",
					  "id" => $shortname."_wc_color_tab_text",
					  "std" => "#515151",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Active Tab",
					  "id" => $shortname."_wc_color_tab_active",
					  "std" => "#000000",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Active Tab Bottom Border",
					  "id" => $shortname."_wc_color_tab_active_border",
					  "std" => "#000000",
					  "desc" => "If changing the active tab colour and content background colour, it's a good idea to edit this color to match your background colour so it shows the tab in an open/active style.",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Active Tab Top Border",
					  "id" => $shortname."_wc_color_tab_active_border_top",
					  "std" => "#646464",
					  "desc" => "This will be the thick border shown above the tabs.",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Tab Borders",
					  "id" => $shortname."_wc_color_tab_borders",
					  "std" => "#646464",
					  "desc" => "This is the left/right and divider borders you'll see around the active tab. Also the border colour applied to the inactive tab borders and divders.",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Product Active Tab Text Colour",
					  "id" => $shortname."_wc_color_tab_active_text",
					  "std" => "#515151",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Alert Background Colour",
					  "id" => $shortname."_wc_color_alerts",
					  "std" => "#313131",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "WooCommerce Alert Text Colour",
					  "id" => $shortname."_wc_color_alerts_text",
					  "std" => "#F1F1F1",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
								  
		$of_options[] = array(  "name" => "WooCommerce Login/Register Screen Background",
					  "id" => $shortname."_wc_login_color",
					  "std" => "#313131",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");	
								  
		$of_options[] = array(  "name" => "WooCommerce Label Text Colour",
					  "id" => $shortname."_wc_label_color",
					  "std" => "#FFFFFF",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
		...
		$of_options[] = array(  "name" => "Divider (hr) Line Colour",
		...
		$of_options[] = array(  "name" => "Comment, Contact &amp; Search Input Button Colour",
					  "id" => $shortname."_input_button_color",
					  "std" => "#353535",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");			
					  
		$of_options[] = array(  "name" => "Comment, Contact &amp; Search Input Button Text Colour",
					  "id" => $shortname."_input_button_color_text",
					  "std" => "#FFFFFF",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Comment, Contact &amp; Search Input Button Border Colour",
					  "id" => $shortname."_input_button_color_border",
					  "std" => "#333333",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Comment, Contact &amp; Search Input Button Mouseover Colour",
					  "id" => $shortname."_input_button_color_mouseover",
					  "std" => "#424242",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");			
					  
		$of_options[] = array(  "name" => "Comment, Contact &amp; Search Input Button Text Mouseover Colour",
					  "id" => $shortname."_input_button_color_text_mouseover",
					  "std" => "#FFFFFF",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Comment, Contact &amp; Search Input Button Mouseover Border",
					  "id" => $shortname."_input_button_color_border_mouseover",
					  "std" => "#333333",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
		...
		$of_options[] = array(  "name" => "Input Field Border Colour",
					  "id" => $shortname."_input_color_border",
					  "std" => "#333333",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
		...
		$of_options[] = array(  "name" => "Alert Background Colour (Alert Shortcodes)",
					  "id" => $shortname."_alert_background_color",
					  "std" => "#191919",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
					  
		$of_options[] = array(  "name" => "Alert Text Colour (Alert Shortcodes)",
					  "id" => $shortname."_alert_text_color",
					  "std" => "#FFFFFF",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_style_prefs",
					  "type" => "color");
		...
		$of_options[] = array(  "name" => "WooCommerce Theme Settings",
					  "id" => $shortname."_woocommerce_prefs",
					  "std" => "<h3 style=\"margin: 0 0 10px; text-align: center;\">WooCommerce Theme Settings</h3>",
					  "type" => "info");
					  
		$of_options[] = array(  "name" => "Enable / Disable the WooCommerce Sidebar",
					  "desc" => "Check this to enable sidebars globally in WooCommerce pages/posts. Can override via page write-panel.",
					  "id" => $shortname."_wc_sidebar_enabled",
					  "type" => "checkbox",
					  "helpicon"=> "help.png",
					  "parent_heading" => $shortname."_woocommerce_prefs",
					  "std" => "0");
					  
		$of_options[] =	array( "name" => "Enable / Disable WooCommerce Shop Prices",
					  "id" => $shortname."_wc_price_enabled",
					  "type" => "select",
					  "options" => array("wc_shop_price_show"=>"Enable WooCommerce Shop Pricing", "wc_shop_price_hidden"=>"Disable WooCommerce Shop Pricing"),
					  "std" => "",
					  "helpicon"=> "help.png",
					  "desc" => "",
					  "parent_heading" => $shortname."_woocommerce_prefs");
